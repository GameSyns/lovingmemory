...
/******/ 			var chunk = require("./" + ({"1":"pages/donation","2":"pages/gallery","3":"pages/index","4":"pages/live-stream","5":"pages/order-of-service"}[chunkId]||chunkId) + ".js");
...
// Module
exports.push([module.i, "html{font-family:\"Lato\",sans-serif;font-size:16px;word-spacing:1px;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;box-sizing:border-box}*,:after,:before{box-sizing:border-box;margin:0}.fa-ulist{margin:10px 0!important;list-style-type:none;position:relative}.fa-icon:before{display:inline-block;text-rendering:auto;-webkit-font-smoothing:antialiased}.fa-list:before{font:var(--fa-font-solid);content:\"\";color:#00def5;margin-right:10px;font-size:12px;position:absolute;top:0;left:5px;height:100%;display:flex;align-items:center}.fa-list{margin:0!important;padding:6px 0 6px 23px;min-height:28px;position:relative}.container{margin:0 auto;min-height:100vh;display:flex;justify-content:center;align-items:center;text-align:center}@media screen and (max-width:800px){.container{flex-direction:column;justify-content:flex-start}}.icon{margin-right:10px;font-size:22px;height:28px;width:27.5px}.section{flex:0 0 50%;min-height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center}@media screen and (max-width:800px){.section{position:fixed;top:0;left:0;width:100%;min-height:auto;height:100%!important;padding-bottom:90px!important}}.section.links{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:bottom 20px left 20px;background-repeat:no-repeat;background-size:200px}@media screen and (max-width:800px){.section.links{padding:0;background-position:bottom 2px left 2px;background-size:150px;position:fixed;top:auto;bottom:0;left:0;width:100%;height:80px!important;background:rgba(30,35,51,.85098);padding-bottom:0!important;z-index:2;-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px)}.section.links ul{display:flex;justify-content:space-around;width:100%;height:100%}.section.links ul li{height:100%;width:20%}.section.links ul li .icon{margin:0}.section.links ul li a{height:100%;padding:0;flex-direction:column;justify-content:center;align-items:center;color:hsla(0,0%,100%,.8);font-size:12px}.section.links ul li a.nuxt-link-exact-active{color:#fff}.section.links ul li a.nuxt-link-exact-active .icon{color:#10e9ff}.section.links ul li a .menu span{display:none}}.section.links ul{padding:0}.section.tribute{background:#2b3143;justify-content:space-evenly;overflow:auto;height:100vh}@media(max-height:600px){.section.tribute{justify-content:normal}}.section.tribute img{box-sizing:content-box;border:8px solid #fff;box-shadow:0 0 10px 3px rgba(0,0,0,.6)}.section.details{background:#2b3143;color:#fff;align-items:flex-start;text-align:left;padding:40px;justify-content:normal;overflow:auto;height:100vh}.section.details p{margin:10px 0;font-weight:300}.section.details p.highlight{background:#008e9d;padding:20px;font-weight:400}.section.details .fa-li{color:#00def5}.section.details ul{font-weight:300;margin:0 0 0 25px;padding:0}.section.details ul li{margin:10px 0}.section.details .title{margin:0 0 25px}.section.details h2{margin:40px 0 5px;align-items:center;display:flex}.section.details h2 em,.section.details h2 span{background:#008e9d;padding:3px 7px;font-size:16px;margin-left:15px;border-radius:4px}.section .button{padding:15px 30px;border-radius:4px;font-size:18px;background:#00def5;text-decoration:none;color:#fff;margin:10px 0;box-shadow:0 0 5px 2px rgba(0,0,0,.3);border-top:1px solid hsla(0,0%,100%,.2);display:inline-block}ul{list-style:none;font-weight:700;text-align:left;font-size:16px}ul a{color:#00def5;text-decoration:none;padding:10px 0;display:flex;align-items:center}ul a.nuxt-link-exact-active{color:#111}.highlight{background:#00def5;padding:3px 7px;font-size:16px;margin-left:15px;border-radius:4px;display:inline-block}.menu small{color:#aeafb3;font-weight:400}.name{font-size:40px;color:#fff}.name,.title{font-weight:300}.title{font-family:\"Pinyon Script\",cursive;display:block;font-size:50px;color:#35495e;letter-spacing:1px;margin:40px 0;color:#fff}@media screen and (max-width:800px){.title{font-size:40px;margin:30px 0}}.subtitle{font-weight:300;font-size:14px;color:#adb4c7;margin:40px 0}@media screen and (max-width:800px){.subtitle{margin:25px 0}}.svg-inline--fa{display:inline-block;font-size:inherit;height:1em;overflow:visible;vertical-align:-.125em}.fa-fw{text-align:center}.fa-ul{list-style-type:none;position:relative}.fa-li{left:-2em;position:absolute;text-align:center;width:2em;line-height:inherit}.svg-inline--fa.fa-w-8{width:.5em}.svg-inline--fa.fa-fw{width:1.25em}", ""]);
// Exports
module.exports = exports;
...
module.exports = __webpack_require__.p + "img/corner.a407a48.svg";
...
const _336f34c2 = () => interopDefault(__webpack_require__.e(/* import() | pages/donation */ 1).then(__webpack_require__.bind(null, 202)));

const _6ef74a52 = () => interopDefault(__webpack_require__.e(/* import() | pages/gallery */ 2).then(__webpack_require__.bind(null, 203)));

const _e3ced1fe = () => interopDefault(__webpack_require__.e(/* import() | pages/live-stream */ 4).then(__webpack_require__.bind(null, 204)));

const _016807ce = () => interopDefault(__webpack_require__.e(/* import() | pages/order-of-service */ 5).then(__webpack_require__.bind(null, 205)));

const _3c7875d2 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 206))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=68f03e78&
var defaultvue_type_template_id_68f03e78_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nuxt')],1)}
var defaultvue_type_template_id_68f03e78_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=68f03e78&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_68f03e78_render,
  defaultvue_type_template_id_68f03e78_staticRenderFns,
  false,
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "Find details on the funeral arrangements for Joey Mendoza"
      }],
      "link": [{
        "rel": "icon",
        "type": "image\u002Fx-icon",
      ...
      "style": [],
      "script": [],
      "title": "In loving memory of Joey Mendoza"
    },
    router,
    nuxt: {
      defaultTransition,
